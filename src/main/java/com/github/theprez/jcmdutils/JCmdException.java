...
public class JCmdException extends Exception {
    ...
    public static JCmdException fromException(final Exception e, final AppLogger _logger) {
        return (e instanceof JCmdException) ? (JCmdException) e : new JCmdException(_logger, FailureType.GENERAL_ERROR, e.getLocalizedMessage());
    }
    ...
    public JCmdException(final AppLogger _logger, final FailureType _failure, final String _messageFmt, final Object... _args) {
        this(_logger, new RuntimeException(), _failure, _messageFmt, _args);
    }

    public JCmdException(final AppLogger _logger, final Throwable _causedBy, final FailureType _failure, final String _messageFmt, final Object... _args) {
